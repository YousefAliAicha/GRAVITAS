(function () {
  ...
  scene.add(new THREE.AmbientLight(0xdba876, 0.85));
  var coolFill = new THREE.PointLight(0x6fa0b0, 0.15, 20, 1.6);
  coolFill.position.set(0, 4.5, -3);
  scene.add(coolFill);

  var bayKeyLight = new THREE.DirectionalLight(0xffd9a0, 1.8);
  bayKeyLight.position.set(-14, 6, 10);
  scene.add(bayKeyLight);

  var pedestalSpotlight = new THREE.SpotLight(0xffe6a3, 2.5);
